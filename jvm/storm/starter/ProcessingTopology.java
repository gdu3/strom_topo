...
public class ProcessingTopology {
	public static void main(String[] args) throws Exception {
		...
		builder.setBolt("bolt_filter", new TestBolt(), 5).shuffleGrouping("bolt_transform").addConfiguration("groupId", "2");
		builder.setBolt("bolt_join1", new TestBolt(), 5).shuffleGrouping("bolt_filter").addConfiguration("groupId", "3");
		builder.setBolt("bolt_output_1", new TestBolt(),5).shuffleGrouping("bolt_join1");

		builder.setBolt("bolt_join2", new TransformBolt(), 5).shuffleGrouping("bolt_transform").addConfiguration("groupId", "4");
		builder.setBolt("bolt_normalize", new TestBolt(), 5).shuffleGrouping("bolt_join2").addConfiguration("groupId", "5");
